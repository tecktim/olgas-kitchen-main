(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function r(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(n){if(n.ep)return;n.ep=!0;const i=r(n);fetch(n.href,i)}})();async function h(){const e=await fetch("/data.json");if(!e.ok)throw new Error(`Failed to load data: ${e.status}`);return e.json()}function f(e){document.title=e;const t=document.querySelector("header h1");console.log("base URL:","/"),t.innerHTML=`<img src="/logo.svg" alt="Logo" class="logo"> ${e}`}function p(e){const t=document.querySelector("nav ul");t.innerHTML="",e.forEach(r=>{const o=document.createElement("li"),n=document.createElement("a");n.href=r.href,n.textContent=r.text,o.appendChild(n),t.appendChild(o)})}function g(e){const t=document.getElementById("home");t.innerHTML=`
  ...
  `}function m(e){const t=document.querySelector(".products");t.innerHTML="",e.forEach(r=>{const o=document.createElement("div");o.className="product",o.dataset.images=JSON.stringify(r.images),o.innerHTML=`
    ...
    `,t.appendChild(o);const n=r.images,i=o.querySelector("img.product-image"),a=o.querySelector("div.product-overlay");let s=0;function u(){const{src:l,overlayText:d}=n[s];i.src="/"+l,a.textContent=d}const c=o.querySelector(".product-image-wrapper");n.length===1&&c.classList.add("single-image"),c.addEventListener("click",l=>{l.stopPropagation();const d=c.getBoundingClientRect();l.clientX-d.left<d.width/2?s=(s-1+n.length)%n.length:s=(s+1)%n.length,u()})})}function b(e){const t=document.getElementById("bestellen");t.innerHTML=`
    <h2>${e.heading}</h2>
    <div class="process">
  ...
  `}function y(e){const t=document.getElementById("kontakt");t.innerHTML=`
    <h2>${e.heading}</h2>
    <p>${e.text.replace(/\n/g,"<br>")}</p>
