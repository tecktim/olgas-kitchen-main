(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const r of e)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function o(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerPolicy&&(r.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?r.credentials="include":e.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(e){if(e.ep)return;e.ep=!0;const r=o(e);fetch(e.href,r)}})();async function b(){const t=await fetch("/data.json");if(!t.ok)throw new Error(`Failed to load data: ${t.status}`);return t.json()}function $(t){document.title=t;const n=document.querySelector("header h1");console.log("base URL:","/"),n.innerHTML=`<img src="/logo.svg" alt="Logo" class="logo"> ${t}`}function L(t){const n=document.querySelector("nav ul");n.innerHTML="",t.forEach(o=>{const a=document.createElement("li"),e=document.createElement("a");e.href=o.href,e.textContent=o.text,a.appendChild(e),n.appendChild(a)})}function E(t){const n=document.getElementById("home");n.innerHTML=`
  ...
  `}function w(t){const n=document.getElementById("feedback");n.innerHTML=`
    <h2>${t.heading}</h2>
    <p>${t.text}</p>
